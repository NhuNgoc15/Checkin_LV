...
export default function Home({ navigation }) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            {/* </TouchableOpacity> */}
            <TouchableOpacity style={styles.buttonContainer} onPress={() => {
                navigation.navigate('ScanQRNav',
                // {
                    // item:data
                // }
                )
            }} >
                <Text style={styles.buttonText}>Điểm danh bằng mã QR</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.buttonContainer} onPress={() => {
                navigation.navigate('ScanBLe')
            }} >
                <Text style={styles.buttonText}>Điểm danh bằng Bluetooth</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.buttonContainer} onPress={() => {
                navigation.navigate('Subscription')
            }} >
                <Text style={styles.buttonText}>Sự kiện đã đăng ký</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.buttonContainer} onPress={() => {
